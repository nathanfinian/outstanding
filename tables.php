    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="tableTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Tanggal</th>
                            <th>Airlines</th>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="post">
                                    <div class="modal-body">
                                        ...
                                        <label for="tagihan" class="form-label">Tagihan (Rp)</label>
                                        ...
                                        <label for="konsesi" class="form-label">Konsesi (%)</label>
